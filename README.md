...
5. Se calcula la variación porcentual por URL entre ambos periodos y se compone la etiqueta de `Periodo Analizado` para documentar el intervalo comparado.
